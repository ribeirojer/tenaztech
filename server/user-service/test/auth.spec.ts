...
describe("POST /auth/forgot-password", () => {
  it("should send a password reset email", async () => {
    const response = await app.handle(post("/api/auth/forgot-password", { email: "user@example.com" }))
  ...
  it("should return 400 if email is missing", async () => {
    const response = await app.handle(post("/api/auth/forgot-password", { email: "" }))
  ...
  it("should return 400 if email is invalid", async () => {
    const response = await app.handle(post("/api/auth/forgot-password", { email: "invalidEmail" }))
  ...
  it("should return 400 if email is not registred", async () => {
    const response = await app.handle(post("/api/auth/forgot-password", { email: "notRegistred@email.com" }))
...
describe("POST /auth/change-password", () => {
  it("Should successfully change the password", async () => {
    ...
    const response = await app.handle(post("/api/auth/change-password", {
...
describe("POST /auth/confirm-email", () => {
  it("Should successfully confirm the e-mail", async () => {
    ...
    const response = await app.handle(post("/api/auth/confirm-email", userData))
