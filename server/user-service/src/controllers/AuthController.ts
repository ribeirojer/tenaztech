...
export class AuthController {
  ...
  public static async forgotPassword(
    ...
    try {
      ...
      set.status = 400
      return { error: "If a user with this email exists, you will receive an email with instructions." }
    }
  }
  ...
  public static async changePassword(
    ...
    try {
      ...
      if (
        ...
        set.status = 400
        return { error: "Password is too weak. It must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, and one number." }
      }
      ...
      const passwordresetexpiresat = new Date(user.passwordresetexpiresat as any)
