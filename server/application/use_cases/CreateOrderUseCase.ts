...
export class CreateOrderUseCase {
    ...
    async execute(customerId: string, productIds: string[], totalAmount: number): Promise<void> {
        ...
        const order = new Order(crypto.randomUUID(), customerId, productIds, 'pending', finalAmount);
