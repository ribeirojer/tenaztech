...
router
  ...
  .get('/api/products/recommendations', productController.getRecommendedProducts)
...
router
  ...
  .patch('/api/inventory/:productId/adjust', inventoryController.adjustStockLevel)
  .get('/api/inventory/availability/:productId', inventoryController.checkAvailability)
...
router
  ...
  .put('/api/products/:productId/reviews/:reviewId', reviewController.updateReview)
  .delete('/api/products/:productId/reviews/:reviewId', reviewController.deleteReview);
