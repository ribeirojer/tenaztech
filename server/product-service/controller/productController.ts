...
export class ProductController {
  ...
  getProductBySlug = async (
    ...
    try {
      ...
      const product = await this.productRepository.getProductBySlug(params.slug);
      if (product) {
        response.body = product;
  ...
  updateProduct = async (
    ...
    try {
      ...
      const product = await this.productRepository.updateProduct(params.id, updatedProduct);
      if (product) {
        response.body = product;
  ...
  searchProductsByName = async ({ request, response }: { request: any; response: any }) => {
    try {
  ...
  getProductsByCategory = async (
    ...
    try {
      ...
      response.body = await this.productRepository.getProductsByCategory(params.category);
      logger.debug(`Products in category: ${params.category} fetched successfully`);
    } catch (error) {
  ...
  getRecommendedProducts = async ({ response }: { response: any }) => {
    try {
  ...
  getProductsByPriceRange = async (
    ...
    try {
      const minPrice = parseFloat(request.url.searchParams.get('minPrice') || '0');
      const maxPrice = parseFloat(request.url.searchParams.get('maxPrice') || 'Infinity');
      logger.info(`Fetching products with price range: ${minPrice} - ${maxPrice}`);
      response.body = await this.productRepository.getProductsByPriceRange(minPrice, maxPrice);
      logger.debug(`Products in price range: ${minPrice} - ${maxPrice} fetched successfully`);
    } catch (error) {
  ...
  getProductsOnSale = async ({ response }: { response: any }) => {
    try {
  ...
  getNewArrivals = async ({ response }: { response: any }) => {
    try {
