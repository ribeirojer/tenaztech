      ...
      <div className="flex flex-col md:flex-row w-full gap-4">
        <div className="flex flex-col w-full md:w-1/2">
          <Input
            ...
            inputRef={refsInfo.firstName} className={""} onChange={function (event: React.ChangeEvent<HTMLInputElement>): void {
        ...
        <div className="flex flex-col w-full md:w-1/2">
          <Input
            ...
            inputRef={refsInfo.lastName} className={""} onChange={function (event: React.ChangeEvent<HTMLInputElement>): void {
              throw new Error("Function not implemented.");
            } }          />
        </div>
      </div>
      <div className="flex flex-col md:flex-row w-full gap-4">
        <div className="flex flex-col w-full md:w-1/2">
          <Input
            ...
            inputRef={refsInfo.email} className={""} onChange={function (event: React.ChangeEvent<HTMLInputElement>): void {
              throw new Error("Function not implemented.");
            } }          />
          {errorEmailRegex && (
        ...
        <div className="flex flex-col w-full md:w-1/2">
          <Input
            ...
            value={info.tel}
            error={errorInfo.tel}
            inputRef={refsInfo.tel} className={""} onChange={function (event: React.ChangeEvent<HTMLInputElement>): void {
              throw new Error("Function not implemented.");
            } }          />
        </div>
      </div>
