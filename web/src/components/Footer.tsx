						...
						<div className="footer">
							...
							<ul className="footer-links space-y-2">
								<li>
									<Link
										href="/sobre-nos"
										className="text-sm hover:text-electric-blue transition"
									>
										Sobre Nós
									</Link>
								</li>
