		...
		<section className="w-full py-12 md:py-24 bg-muted">
			<div className="container mx-auto grid items-center justify-center gap-8 px-4 text-center md:px-6">
				...
				<div className="grid grid-cols-2 gap-4 md:gap-8 md:grid-cols-4">
					<Link
						href="/termos-e-condicoes#frete-gratis"
						className="cursor-pointer bg-glow-tech bg-opacity-50 flex flex-col items-center justify-center space-y-4 rounded-lg bg-white p-6 shadow-lg transition-transform transform hover:scale-105"
					>
					...
					<Link
						href="/termos-e-condicoes#garantia"
						className="cursor-pointer bg-sandstorm bg-opacity-50 flex flex-col items-center justify-center space-y-4 rounded-lg bg-white p-6 shadow-lg transition-transform transform hover:scale-105"
					>
					...
					<Link
						href="/termos-e-condicoes#entrega-rapida"
						className="cursor-pointer bg-electric-blue bg-opacity-50 flex flex-col items-center justify-center space-y-4 rounded-lg bg-white p-6 shadow-lg transition-transform transform hover:scale-105"
					>
					...
					<Link
						href="/termos-e-condicoes#cupons"
						className="cursor-pointer bg-pink-pulse bg-opacity-50 flex flex-col items-center justify-center space-y-4 rounded-lg bg-white p-6 shadow-lg transition-transform transform hover:scale-105"
					>
