...
const Header = (props: Props) => {
	...
	return (
		<header id="header">
			<div className="relative mb-[118px]">
				<TopHeader isTopHeaderVisible={isTopHeaderVisible} />
				<div
					className={`bg-midnight fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${isTopHeaderVisible ? "mt-9" : "mt-0"}`}
				>
