		...
		<Layout>
			<div className="container mx-auto py-8 px-4">
				...
				<div className="bg-white rounded-lg p-4">
					...
					<p className="mb-4">
						A TenazTech coleta informações pessoais dos usuários de várias
						formas, incluindo informações fornecidas voluntariamente pelos
						usuários, como nome, endereço de e-mail, endereço de entrega e
						informações de pagamento ao fazer uma compra.
					</p>
					...
					<p className="mb-4">
						...
						recebê-las. As informações pessoais dos usuários nunca serão
						vendidas, alugadas ou compartilhadas com terceiros não afiliados sem
						consentimento prévio.
					</p>

					<h2 className="text-lg font-semibold mb-2">3. Cookies</h2>
					<p className="mb-4">
						A TenazTech utiliza cookies para melhorar a experiência do usuário
						no site, fornecer funcionalidades essenciais, analisar o tráfego e
						personalizar o conteúdo. Os usuários podem optar por recusar
					...
					<p className="mb-4">
						...
						administrativas adequadas para proteger contra acesso não
					...
					<p>
						Se os usuários tiverem dúvidas ou preocupações sobre esta Política
						de Privacidade, podem entrar em contato conosco através dos canais
						de comunicação fornecidos no site.
					</p>
				</div>
			</div>
		</Layout>
