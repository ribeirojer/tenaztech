<template>
    <section class="relative z-10 bg-purple-500 py-[120px]">
             ...
             <div class="w-full px-4">
                <div class="mx-auto max-w-[400px] text-center">
                   ...
                   <a
                      ...
                      class="inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white hover:text-purple-500"
                      >
                   Voltar ao início
                   </a>
                </div>
  ...
  <style scoped>
  /* Estilos para a página de não encontrado */
  </style>
