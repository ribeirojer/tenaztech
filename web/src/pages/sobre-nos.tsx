			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					<div>
						...
						<p className="mb-4">
							A TenazTech é um e-commerce recém-inaugurado, nascido da paixão
							por tecnologia e inovação. Embora recente, nossa equipe está
							empenhada em oferecer uma experiência de compra excepcional para
							entusiastas da tecnologia em todo o mundo.
						</p>
						<p className="mb-4">
					...
					<div>
						...
						<p className="mb-4">
							...
							para os consumidores em busca de produtos eletrônicos de qualidade
							a preços acessíveis. Estamos comprometidos em construir uma marca
						...
						<p className="mb-4">
							...
							excelência, podemos alcançar nossos objetivos e contribuir de
							forma significativa para o mundo da tecnologia.
						</p>
					</div>
				</div>
				...
				<div className="mt-8">
					...
					<ul className="list-disc pl-4">
						<li className="mb-2">
							<span className="font-semibold">Qualidade:</span> Comprometemo-nos
							a oferecer apenas produtos eletrônicos de alta qualidade,
						...
						<li className="mb-2">
							<span className="font-semibold">Transparência:</span> Valorizamos
							a transparência em todas as nossas operações, desde preços até
