...
<template>
  <div class="text-center">
    <div
      class="inline-flex p-4 mb-12 bg-white border rounded-xl border-stroke dark:bg-dark-2 dark:border-dark-3"
    >
      <ul class="-mx-[6px] flex items-center">
        <li class="px-[6px]">
          <a
            ...
            class="flex items-center justify-center text-base bg-transparent border rounded-md hover:border-primary hover:bg-primary h-9 w-9 border-stroke dark:border-dark-3 text-body-color hover:text-white"
          >
            <span>
